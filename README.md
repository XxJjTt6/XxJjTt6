...
| Window | Tokens | Cost |
| --- | ---: | ---: |
| Today | 31,869,383 | $36.89 |
| This week | 486,492,350 | $520.97 |
| This month | 512,096,915 | $549.30 |
| Last 7 days | 512,096,915 | $549.30 |
| Last 30 days | 8,983,982,907 | $9,134.26 |
| All time | 20,961,231,076 | $20,538.38 |

## Sources

| Source | Tokens | Cost | Messages |
| --- | ---: | ---: | ---: |
| Codex | 16,981,984,780 | $16,206.03 | 118,400 |
...
| --- | ---: | ---: | ---: |
| gpt-5.5 | 8,810,280,521 | $8,370.89 | 67,903 |
| gpt-5.6-sol | 7,663,070,852 | $7,489.31 | 45,883 |
...
<sub>Updated 2026-08-07. Public aggregate data from Tokscale 4.10.0; live graphs served by Tokscale.</sub>
