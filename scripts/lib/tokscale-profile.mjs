...
<img src="./assets/tokscale-ai-usage-card.svg" alt="${profileName} Tokscale AI usage summary" width="860">
...
<sub>Updated ${summary.asOfDate}. Data generated by Tokscale ${summary.tokscaleVersion ?? ""}; local aggregate logs only.</sub>
`;
}
